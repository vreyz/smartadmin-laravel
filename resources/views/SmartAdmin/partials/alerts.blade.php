@if($error = session()->get('error'))
    <div class="alert alert-danger alert-dismissable">
        ...
        <h4><i class="icon falfa-ban"></i>{{ \Illuminate\Support\Arr::get($error->get('title'), 0) }}</h4>
...
@if($success = session()->get('success'))
    <div class="alert alert-success alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h4><i class="icon falfa-check"></i>{{ \Illuminate\Support\Arr::get($success->get('title'), 0) }}</h4>
...
@if($info = session()->get('info'))
    <div class="alert alert-info alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h4><i class="icon falfa-info"></i>{{ \Illuminate\Support\Arr::get($info->get('title'), 0) }}</h4>
...
@if($warning = session()->get('warning'))
    <div class="alert alert-warning alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        <h4><i class="icon falfa-warning"></i>{{ \Illuminate\Support\Arr::get($warning->get('title'), 0) }}</h4>
