@if($errors->hasBag('exception') && config('app.debug') == true)
    ...
    <div class="alert alert-warning alert-dismissable">
        ...
        <p><a style="cursor: pointer;" onclick="$('#laravel-admin-exception-trace').toggleClass('hidden');$('i', this).toggleClass('fa-angle-double-down fa-angle-double-up');"><i class="falfa-angle-double-down"></i>&nbsp;&nbsp;{!! $error->first('message') !!}</a></p>
