...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="{{ admin_asset("vendor/smartadmin-laravel/SmartAdmin/css/fa-brands.css") }}">
    </head>
    <!-- BEGIN Body -->
    <!-- Possible Classes
        ...
        <div class="page-wrapper auth">
            <div class="page-inner bg-brand-gradient">
                <div class="page-content-wrapper bg-transparent m-0">
                        ...
                        <div class="d-flex align-items-center container p-0">
                            <div class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                                <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                                    <img src="{{admin_asset(config('admin.logo.image-circle'))}}" alt="{{config('admin.name')}} WebApp" aria-roledescription="logo">
                    ...
                    <div class="flex-1" style="background: url({{admin_asset("vendor/smartadmin-laravel/SmartAdmin/img/svg/pattern-1.svg")}}) no-repeat center bottom fixed; background-size: cover;">
