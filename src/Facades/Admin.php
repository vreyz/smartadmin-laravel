 ...
 * Class Admin.
 *
 * @method static \Vreyz\Admin\Grid grid($model, \Closure $callable)
 * @method static \Vreyz\Admin\Form form($model, \Closure $callable)
 * @method static \Vreyz\Admin\Show show($model, $callable = null)
 * @method static \Vreyz\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Vreyz\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \Vreyz\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Vreyz\Admin\Admin::class;
    }
}
