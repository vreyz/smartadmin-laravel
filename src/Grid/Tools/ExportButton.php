...
EOT;
        ...
        <div class="btn-group" style="margin-right: 10px">
            <a href="{$this->grid->getExportUrl('all')}" target="_blank" class="btn btn-sm btn-info" title="{$trans['export']}"><i class="fas fa-download"></i><span class="hidden-xs"> {$trans['export']}</span></a>
