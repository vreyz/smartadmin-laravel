...
class Tags extends Field
{
    ...
    protected static $css = [
        '/vendor/smartadmin-laravel/SmartAdmin/css/formplugins/select2/select2.bundle.css',
    ];
     ...
     */
    protected static $js = [
        '/vendor/smartadmin-laravel/SmartAdmin/js/formplugins/select2/select2.bundle.js',
    ];
