...
class File extends Field
{
     ...
     * @var array
     */
    protected static $css = ['/vendor/smartadmin-laravel/smartadmin/css/file-picker/fileinput.min.css'];
     ...
     * @var array
     */
    protected static $js = ['/vendor/smartadmin-laravel/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js',
        '/vendor/smartadmin-laravel/smartadmin/js/file-picker/plugins/popper.min.js',
        '/vendor/smartadmin-laravel/smartadmin/js/file-picker/plugins/piexif.min.js',
        '/vendor/smartadmin-laravel/smartadmin/js/file-picker/fileinput.min.js',
        '/vendor/smartadmin-laravel/smartadmin/js/file-picker/themes/fas/theme.min.js',];
...
EOT;
    ...
    public function render()
    {
        ...
        if (Admin::Themes('smartadmin')) {
            $theme = array('theme' => 'fas');
            $this->options = array_merge($theme, $this->options);
        }
