...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/vendor/smartadmin-laravel/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css',
    ];

    protected static $js = [
        '/vendor/smartadmin-laravel/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js',
    ];
