...
class SwitchField extends Field
{
    protected static $css = [
        '/vendor/smartadmin-laravel/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css',
    ];

    protected static $js = [
        '/vendor/smartadmin-laravel/bootstrap-switch/dist/js/bootstrap-switch.min.js',
    ];
