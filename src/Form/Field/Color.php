...
class Color extends Text
{
    protected static $css = [
        '/vendor/smartadmin-laravel/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css',
    ];

    protected static $js = [
        '/vendor/smartadmin-laravel/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.js',
    ];
