...
namespace Vreyz\Admin\Form;

use Vreyz\Admin\Admin;
use Vreyz\Admin\Form;
use Vreyz\Admin\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \Vreyz\Admin\Form|\Vreyz\Admin\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \Vreyz\Admin\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
