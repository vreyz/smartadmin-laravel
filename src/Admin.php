...
use Closure;
use Vreyz\Admin\Auth\Database\Menu;
use Vreyz\Admin\Controllers\AuthController;
use Vreyz\Admin\Layout\Content;
use Vreyz\Admin\Traits\HasAssets;
use Vreyz\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \Vreyz\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \Vreyz\Admin\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\Vreyz\Admin\Controllers')->group(function ($router) {
            ...
            $router->post('/locale', '\Vreyz\Admin\Controllers\MultiLanguageController@locale');
    ...
    public static function Themes($themes)
    {
        if (isset($themes))
        {
            return strtolower(config('admin.themes.theme')) == strtolower($themes);
        } else {
            return strtolower(config('admin.themes.theme'));
        }
    }
