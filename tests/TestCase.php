...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Vreyz\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Vreyz\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Vreyz\Admin\AdminServiceProvider']);
...
//        \Vreyz\Admin\Admin::$css = [];
//        \Vreyz\Admin\Admin::$js = [];
//        \Vreyz\Admin\Admin::$script = [];
    }
    ...
    protected function tearDown(): void
    {
        ...
        DB::select("delete from `migrations` where `migration` = '2021_01_24_173148_create_admin_tables'");
