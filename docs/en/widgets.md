...
`Vreyz\Admin\Widgets\Box` used to generate box components:

```php
use Vreyz\Admin\Widgets\Box;
...
`Vreyz\Admin\Widgets\Collapse` class used to generate folding components:
```php
use Vreyz\Admin\Widgets\Collapse;
...
`Vreyz\Admin\Widgets\Form` class is used to quickly build a form:
...
`Vreyz\Admin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use Vreyz\Admin\Widgets\InfoBox;
...
`Vreyz\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use Vreyz\Admin\Widgets\Tab;
...
`Vreyz\Admin\Widgets\Table` class is used to generate tables:

```php
use Vreyz\Admin\Widgets\Table;
