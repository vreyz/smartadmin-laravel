...
[![Packagist](https://img.shields.io/packagist/l/vreyz/laravel-admin.svg?maxAge=2592000)](https://packagist.org/packages/vreyz/laravel-admin)
[![Total Downloads](https://img.shields.io/packagist/dt/vreyz/laravel-admin.svg?style=flat-square)](https://packagist.org/packages/vreyz/laravel-admin)
...
```
composer require vreyz/laravel-admin 1.5.*
```
